...
historyBtn.addEventListener('click', () => {
  ...
  if (keypad.style.display === 'grid') {
    resultDisplay.style.di = 'hidden'
    calculationDisplay.style.di = 'hidden'
    historyDisplay.style.di = 'visible'
    keypad.style.display = 'none'
  } else {
    resultDisplay.style.di = 'visible'
    calculationDisplay.style.di = 'visible'
    historyDisplay.style.di = 'hidden'
