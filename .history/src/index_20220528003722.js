...
historyBtn.addEventListener('click', () => {
  ...
  calculationDisplay.style.visibility = 'hidden'
  
  if (keypad.style.display === 'grid') {
    resultDisplay.style.display = 'hidden'
    calculationDisplay.style.display = 'hidden'
    historyDisplay.style.display = 'visible'
    keypad.style.display = 'none'
  } else {
    resultDisplay.style.display = 'visible'
    calculationDisplay.style.display = 'visible'
    historyDisplay.style.display = 'hidden'
